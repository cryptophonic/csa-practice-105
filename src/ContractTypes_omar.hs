...
module ContractTypes_omar (SimpleSale (..), PSimpleSale (..), MarketRedeemer (..), PMarketRedeemer (..)) where
...
instance PUnsafeLiftDecl PMarketRedeemer where type PLifted PMarketRedeemer = MarketRedeemer -- plift Plutarch -> PlutusTx
